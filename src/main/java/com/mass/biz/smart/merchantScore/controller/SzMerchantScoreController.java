...
public class SzMerchantScoreController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/selectThelastScore", method = RequestMethod.POST)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/outsideInsert", method = RequestMethod.POST)
	public AjaxResponse outsideInsert(Long user_id, int type) {
//		int count = merchantScoreService.outsideInsert(user_id, type);
		int count = merchantScoreService.outsideInsert(81L, SzMerchantScore.SUGGESTION_TYPE);
		return AjaxResponse.success("ok", count);
	}
}
