package com.mass.biz.smart.merchantMgt.model;
 ...
 * @author jiangd
 */
public class SzMerchantMgt implements Serializable {
	...
	public Long getOld_userId() {
		return old_userId;
	}

	public void setOld_userId(Long old_userId) {
